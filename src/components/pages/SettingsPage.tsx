          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="p-6 bg-[#0B0B0D] rounded-xl ring-2 ring-[#FFCB00] text-left">
                  ...
                  <p className="text-xs text-[#AAB0B8]">Current theme</p>
                </button>
                <button className="p-6 bg-[#0B0B0D] rounded-xl ring-1 ring-white/10 hover:ring-[#FFCB00]/50 transition-all text-left">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#F6F7F9] to-[#ffffff] rounded-lg mb-3" />
                  <p className="text-sm mb-1">Light</p>
                  <p className="text-xs text-[#AAB0B8]">Coming soon</p>
                </button>
              </div>
            </div>
