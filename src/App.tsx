...
import { VoiceCloningPage } from './components/pages/VoiceCloningPage';
import { AIStoriesPage } from './components/pages/AIStoriesPage';
import { MovieStudioPage } from './components/pages/MovieStudioPage';
import { FilmStudioPage } from './components/pages/FilmStudioPage';
        ...
        {!isLoggedIn ? (
          ...
          >
            ...
            <div className="relative min-h-screen">
              ...
              <div className="hidden lg:block fixed top-8 left-8 z-20">
              ...
              <div className="hidden lg:grid lg:grid-cols-[65%_35%] min-h-screen">
                ...
                <div className="relative bg-[#0B0B0D]">
                  {showContent && <LoginCard onLoginSuccess={handleLoginSuccess} />}
                </div>
              </div>
